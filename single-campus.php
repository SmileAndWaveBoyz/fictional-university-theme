<?php
  ...
  while(have_posts()) {
    ...
    ?>
      ...
      <div class="acf-map">
            <div class="marker" data-lat="<?php echo $mapLocation['lat'] ?>" data-lng="<?php echo $mapLocation['lng'] ?>"x>
      ...
      <?php
        ...
        if ($relatedPrograms->have_posts()) {
            ...
            echo '<h2 class="headline headline--medium">Programs Avaulable At This Campus</h2>';
